...
import ProLayout from "layouts/ProLayout.js";

export default function Pro({posts}) {
              ...
              <div className="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
                <div className="pr-12">
                  <h1 className="text-white font-semibold text-5xl">
                    Learn Technology - Get A Rad Job
                  </h1>
                  <p className="mt-4 text-lg text-blueGray-200">
                    Hi! My name is Brendan and I am passionate about helping otherds learn technolgy. 
                  </p>
                </div>
              </div>
            </div>
