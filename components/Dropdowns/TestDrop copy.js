...
const TestDrop = () => {
  ...
  return (
    <>
      <div className="flex flex-wrap bg-blueGray-600">
        <div className="w-full sm:w-6/12 md:w-4/12 px-4 bg-blueGray-600">
          <div className="relative inline-flex align-middle w-full bg-blueGray-600">
            <button
              className="text-white z-1 font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 bg-blueGray-500 active:bg-blueGray-100 ease-linear transition-all duration-150"
              type="button"
              ref={btnDropdownRef}
              onClick={() => {
                dropdownPopoverShow
